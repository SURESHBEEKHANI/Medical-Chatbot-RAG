  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        quickAction: "bg-card border border-border text-foreground hover:bg-accent hover:border-primary/30 shadow-sm hover:-translate-y-0.5 hover:shadow-md",
        auth: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-md hover:shadow-lg h-12 text-base font-semibold",
        authOutline: "border-2 border-border bg-background hover:bg-accent hover:border-primary/30 h-12 text-base font-medium",
      },
      size: {
